    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <motion.div 
          ...
          className="card bg-primary-50 border-primary-100 dark:bg-primary-900/10 dark:border-primary-900/20"
        >
          <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900/30">
            <Info className="h-5 w-5 text-primary-600 dark:text-primary-400" />
          </div>
          <h3 className="mb-2 text-lg font-medium dark:text-gray-100">Why Accessibility Matters</h3>
        ...
        <motion.div 
          ...
          className="card bg-warning-50 border-warning-100 dark:bg-warning-900/10 dark:border-warning-900/20"
        >
          <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-warning-100 dark:bg-warning-900/30">
            <AlertTriangle className="h-5 w-5 text-warning-600 dark:text-warning-400" />
          </div>
          <h3 className="mb-2 text-lg font-medium dark:text-gray-100">Common Issues</h3>
          <p className="mb-4 text-gray-600 dark:text-gray-400">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="relative">
            <div className="absolute left-8 top-8 -ml-px h-full w-0.5 bg-gray-200 dark:bg-gray-800 lg:left-0 lg:ml-0 lg:w-full lg:h-0.5 lg:top-8"></div>
            <div className="relative flex flex-col pb-8 lg:pb-0">
              <div className="flex items-center mb-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary-600 text-white dark:bg-primary-500">
                  1
                </div>
                <h3 className="ml-4 text-lg font-medium dark:text-gray-100">Enter Your URL</h3>
              </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex flex-col pb-8 lg:pb-0">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-4 text-lg font-medium dark:text-gray-100">Automated Analysis</h3>
              </div>
              <div className="ml-14 lg:ml-0 lg:mt-3">
                <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="relative">
            <div className="relative flex flex-col">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-4 text-lg font-medium dark:text-gray-100">Get Results</h3>
              </div>
              <div className="ml-14 lg:ml-0 lg:mt-3">
                <p className="text-gray-600 dark:text-gray-400">
